...
properties([
    parameters([
        ...
        [
            ...
            choiceType: 'PT_SINGLE_SELECT',
            description: 'Mode to run.<br/>\'update\' -> Update functions.<br/>\'compare\' -> Compare function image and environment variables.<br/>\'details\' -> View the function details<br/>',
